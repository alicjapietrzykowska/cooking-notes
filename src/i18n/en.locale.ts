export default {
  ...
  validation: {
    ...
    invalidUrl: "Invalid URL format. http:// or https:// expected",
    required: "Field required",
    weakPassword:
      "Password should have at least 6 characters, at least one upper case letter, one lower case letter and one number",
  },
};
